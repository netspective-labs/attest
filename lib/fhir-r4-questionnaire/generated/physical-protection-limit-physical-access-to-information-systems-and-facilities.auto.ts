 ...
 * @generated This file was auto-generated at 2025-08-17T01:00:18.927Z from the FHIR R4 Questionnaire "Physical Protection (Limit physical access to information systems and facilities)".
...
export function physicalProtectionLimitPhysicalAccessToInformationSystemsAndFacilitiesLhcFormResponseAdapter(
  ...
  return {
    howManyIndividualsAreAuthorizedForPhysicalAccessToFciAreasFillInTheTotalForEach:
      coerceOptionalString(findLhcValueByLinkId(input, "324592389560")),
    fullTimeEmployees: coerceOptionalNumber(
      findLhcValueByLinkId(input, "436045572485"),
    ),
    contractors: coerceOptionalNumber(
      findLhcValueByLinkId(input, "857782926958"),
    ),
    partTimeEmployees: coerceOptionalNumber(
      findLhcValueByLinkId(input, "944400994758"),
    ),
    visitorsWithEscort: coerceOptionalNumber(
      findLhcValueByLinkId(input, "571574306369"),
    ),
    whatAreasRequireControlledPhysicalAccess: coerceOptionalString(
      findLhcValueByLinkId(input, "702794466613"),
    ),
    whoAuthorizesPhysicalAccessToControlledAreas: coerceOptionalString(
      findLhcValueByLinkId(input, "784352573703"),
    ),
    whatTypesOfPhysicalAccessCredentialsAreIssued: coerceOptionalString(
      findLhcValueByLinkId(input, "773851219827"),
    ),
    areThereTimeBasedRestrictionsOnPhysicalAccess: coerceOptionalString(
      findLhcValueByLinkId(input, "208747627440"),
    ),
    implementationStatus: coerceOptionalString(
      findLhcValueByLinkId(input, "660777712272"),
    ),
    doesYourOrganizationRequireAllVisitorsToBeEscorted: coerceOptionalString(
      findLhcValueByLinkId(input, "684131391577"),
    ),
    howAreVisitorsIdentifiedAndDistinguishedFromEmployees: coerceOptionalString(
      findLhcValueByLinkId(input, "400470675855"),
    ),
    howIsVisitorActivityMonitoredWhileOnPremises: coerceOptionalString(
      findLhcValueByLinkId(input, "829474009766"),
    ),
    whoIsAuthorizedToEscortVisitors: coerceOptionalString(
      findLhcValueByLinkId(input, "422650784362"),
    ),
    implementationStatus2: coerceOptionalString(
      findLhcValueByLinkId(input, "231843690847"),
    ),
    howDoYouLogPhysicalAccessToYourFacilities: coerceOptionalString(
      findLhcValueByLinkId(input, "734633292283"),
    ),
    whatInformationIsCapturedInYourPhysicalAccessLogsInformationCapturedInLogs:
      coerceOptionalString(findLhcValueByLinkId(input, "174905707594")),
    howLongArePhysicalAccessLogsRetained: coerceOptionalString(
      findLhcValueByLinkId(input, "245305278102"),
    ),
    howFrequentlyAreAccessLogsReviewed: coerceOptionalString(
      findLhcValueByLinkId(input, "741567851452"),
    ),
    whoReviewsThePhysicalAccessLogs: coerceOptionalString(
      findLhcValueByLinkId(input, "745836226925"),
    ),
    implementationStatus3: coerceOptionalString(
      findLhcValueByLinkId(input, "320438032270"),
    ),
    whatTypesOfPhysicalAccessDevicesDoesYourOrganizationUse:
      coerceOptionalString(findLhcValueByLinkId(input, "903629274308")),
    howArePhysicalAccessDevicesControlledAndManaged: coerceOptionalString(
      findLhcValueByLinkId(input, "173451266066"),
    ),
    whatSecurityMeasuresProtectPhysicalAccessDevices: coerceOptionalString(
      findLhcValueByLinkId(input, "911514884520"),
    ),
    howFrequentlyAreElectronicAccessSystemsUpdated: coerceOptionalString(
      findLhcValueByLinkId(input, "466342459779"),
    ),
    implementationStatus4: coerceOptionalString(
      findLhcValueByLinkId(input, "294892506040"),
    ),
  };
}
...
export function physicalProtectionLimitPhysicalAccessToInformationSystemsAndFacilitiesFhirQuestionnaireResponseAdapter(
  ...
  return {
    howManyIndividualsAreAuthorizedForPhysicalAccessToFciAreasFillInTheTotalForEach:
      coerceOptionalString(findQrAnswerByLinkId(qr, "324592389560")),
    fullTimeEmployees: coerceOptionalNumber(
      findQrAnswerByLinkId(qr, "436045572485"),
    ),
    contractors: coerceOptionalNumber(findQrAnswerByLinkId(qr, "857782926958")),
    partTimeEmployees: coerceOptionalNumber(
      findQrAnswerByLinkId(qr, "944400994758"),
    ),
    visitorsWithEscort: coerceOptionalNumber(
      findQrAnswerByLinkId(qr, "571574306369"),
    ),
    whatAreasRequireControlledPhysicalAccess: coerceOptionalString(
      findQrAnswerByLinkId(qr, "702794466613"),
    ),
    whoAuthorizesPhysicalAccessToControlledAreas: coerceOptionalString(
      findQrAnswerByLinkId(qr, "784352573703"),
    ),
    whatTypesOfPhysicalAccessCredentialsAreIssued: coerceOptionalString(
      findQrAnswerByLinkId(qr, "773851219827"),
    ),
    areThereTimeBasedRestrictionsOnPhysicalAccess: coerceOptionalString(
      findQrAnswerByLinkId(qr, "208747627440"),
    ),
    implementationStatus: coerceOptionalString(
      findQrAnswerByLinkId(qr, "660777712272"),
    ),
    doesYourOrganizationRequireAllVisitorsToBeEscorted: coerceOptionalString(
      findQrAnswerByLinkId(qr, "684131391577"),
    ),
    howAreVisitorsIdentifiedAndDistinguishedFromEmployees: coerceOptionalString(
      findQrAnswerByLinkId(qr, "400470675855"),
    ),
    howIsVisitorActivityMonitoredWhileOnPremises: coerceOptionalString(
      findQrAnswerByLinkId(qr, "829474009766"),
    ),
    whoIsAuthorizedToEscortVisitors: coerceOptionalString(
      findQrAnswerByLinkId(qr, "422650784362"),
    ),
    implementationStatus2: coerceOptionalString(
      findQrAnswerByLinkId(qr, "231843690847"),
    ),
    howDoYouLogPhysicalAccessToYourFacilities: coerceOptionalString(
      findQrAnswerByLinkId(qr, "734633292283"),
    ),
    whatInformationIsCapturedInYourPhysicalAccessLogsInformationCapturedInLogs:
      coerceOptionalString(findQrAnswerByLinkId(qr, "174905707594")),
    howLongArePhysicalAccessLogsRetained: coerceOptionalString(
      findQrAnswerByLinkId(qr, "245305278102"),
    ),
    howFrequentlyAreAccessLogsReviewed: coerceOptionalString(
      findQrAnswerByLinkId(qr, "741567851452"),
    ),
    whoReviewsThePhysicalAccessLogs: coerceOptionalString(
      findQrAnswerByLinkId(qr, "745836226925"),
    ),
    implementationStatus3: coerceOptionalString(
      findQrAnswerByLinkId(qr, "320438032270"),
    ),
    whatTypesOfPhysicalAccessDevicesDoesYourOrganizationUse:
      coerceOptionalString(findQrAnswerByLinkId(qr, "903629274308")),
    howArePhysicalAccessDevicesControlledAndManaged: coerceOptionalString(
      findQrAnswerByLinkId(qr, "173451266066"),
    ),
    whatSecurityMeasuresProtectPhysicalAccessDevices: coerceOptionalString(
      findQrAnswerByLinkId(qr, "911514884520"),
    ),
    howFrequentlyAreElectronicAccessSystemsUpdated: coerceOptionalString(
      findQrAnswerByLinkId(qr, "466342459779"),
    ),
    implementationStatus4: coerceOptionalString(
      findQrAnswerByLinkId(qr, "294892506040"),
    ),
  };
}
