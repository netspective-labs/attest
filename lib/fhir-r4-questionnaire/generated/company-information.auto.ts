 ...
 * @generated This file was auto-generated at 2025-08-16T21:04:32.496Z from the FHIR R4 Questionnaire "Company Information".
...
type Any = any;
import { coerceBoolean, coerceDate, coerceNumber, coerceString, coerceOptionalBoolean, coerceOptionalDate, coerceOptionalNumber, coerceOptionalString, findLhcValueByLinkId, findQrAnswerByLinkId, isBlank } from "../r4q-runtime.ts";
/**
...
export function CompanyInformationLhcFormResponseAdapter(input: Any): CompanyInformation {
  ...
  positionTitle: coerceOptionalString(findLhcValueByLinkId(input, "761144039651")),
  ...
  assessmentDate: coerceOptionalDate(findLhcValueByLinkId(input, "276403539223")),
  industry: coerceOptionalString(findLhcValueByLinkId(input, "789286873476")),
  employeeCount: coerceOptionalString(findLhcValueByLinkId(input, "697235963218")),
  contractTypes: coerceOptionalString(findLhcValueByLinkId(input, "863463230823")),
  cageCode: coerceOptionalString(findLhcValueByLinkId(input, "805221373063")),
  dunsNumber: coerceOptionalString(findLhcValueByLinkId(input, "374784155003")),
  };
}
...
export function CompanyInformationFhirQuestionnaireResponseAdapter(qr: Any): CompanyInformation {
  ...
  positionTitle: coerceOptionalString(findQrAnswerByLinkId(qr, "761144039651")),
  ...
  assessmentDate: coerceOptionalDate(findQrAnswerByLinkId(qr, "276403539223")),
  industry: coerceOptionalString(findQrAnswerByLinkId(qr, "789286873476")),
  employeeCount: coerceOptionalString(findQrAnswerByLinkId(qr, "697235963218")),
  contractTypes: coerceOptionalString(findQrAnswerByLinkId(qr, "863463230823")),
