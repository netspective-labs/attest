 ...
 * CLI code generator: FHIR R4 Questionnaire → type-safe `.auto.ts` modules.
 *
 * Usage:
...
export function renderHeaderBanner(
    ...
    return `/**
 * @file ${filename}
 * @generated This file was auto-generated at ${stamp} from the FHIR R4 Questionnaire "${title}".
